...
const testimonials = [
    {
        name: 'Rahel Weldemariyam Beyene',
        role: 'Student',
        content:
            'Welcome to Resume Builder, your go-to tool for creating professional resumes with ease. Our intuitive platform guides you through each step, offering customizable templates and real-time previews to ensure your resume stands out. Download your polished resume in PDF format and take the next step in your career with confidence. Simplify the resume creation process and make a lasting impression on potential employers..',
    ...
    return (
        <>
            <Helmet>
                ...
                <meta name="author" content="Rahel Weldemariyam Beyene" />
